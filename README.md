...
(*NOTE:* `vickitrix` versions < 0.1.2 didn't work with the default rules because they were case-sensitive. If you've already followed the instructions below, you can upgrade to the latest version of `vickitrix` with
